...
class Admin extends Common {
    ...
    public function setGroup() {
        ...
        // 获取管理员信息
        $adminData = $this->db->field('id,uname')->find($admin_id);
        $this->assign('adminData', $adminData);

        // 获取当前已分组的 ID
        $accessData = db('ls_admin_group')->where('admin_id', $admin_id)->column('group_id');
        $this->assign('accessData', $accessData);

        // 获取分组信息
        $groupData = db('ls_group')->where('status', 1)->select();
